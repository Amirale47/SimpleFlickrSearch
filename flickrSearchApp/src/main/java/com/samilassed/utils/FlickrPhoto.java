...
public class FlickrPhoto implements IThumb {
	String id;
	int position;
	String thumbURL;
	Bitmap thumb;
	...
	public FlickrPhoto(String id, String thumbURL, String largeURL, String owner, String secret, String server, String farm) {
		super();
		this.id = id;
		this.owner = owner;
		this.secret = secret;
	...
	private String createPhotoURL(int photoType, FlickrPhoto imgCon) {
		String tmp = null;
	...
	/*@Override
	public void onSaveThumbURL(UIHandler uih, FlickrPhoto ic) {
